...
class Dialer {
    ...
    async connectToPeer(peer, options = {}) {
        ...
        if (await this.connectionGater.denyDialPeer(id)) {
            throw errCode(
                new Error("The dial request is blocked by gater.allowDialPeer"),
        ...
        const pendingDial =
            this._pendingDials.get(dialTarget.id) || this._createPendingDial(dialTarget, options);
